...
wiot2014 = importdata('WIOD_data/WIOT2014_Nov16_ROW.csv');
%% Intermediate supply-use table
Z = wiot2014.data(1:2464, 1:2464);
%% Value added
VA = wiot2014.data(2470,1:2464);
%% Output
X = wiot2014.data(2472,1:2464);
%% Final demand
FD = wiot2014.data(1:2464,2465:2684);
%% taxes less subsidies on intermediate products
TLS_intermediate = wiot2014.data(2467,1:2464);
%% taxes less subsidies on final products
TLS_final = wiot2014.data(2467,2465:2684);
